...
const handleDatabaseQuery = (event, { table, action, payload }) => {
  ...
  switch (action) {
    case 'select':
      // The client query builder will filter, order, and join this result
    ...
    case 'insert': {
      ...
      // Notify renderer processes of database updates for realtime changes
    ...
    // Session operations for authentication persistence
    case 'get_session':
